...
\title{Determining Rumour Veracity and Support for Rumours}

\name{Mihaela Baksic, Ivor Leon Matijašić, Karina Szubert} 

\address{
University of Zagreb, Faculty of Electrical Engineering and Computing\\
Unska 3, 10000 Zagreb, Croatia\\ 
 \texttt{\{autor1, autor2, karina.szubert\}@fer.hr}\\
}
